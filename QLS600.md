...
4. Prepare a 2-3 page summary report of what you found, including a genome browser figure showing an example target gene (with RNA-seq and ChIP-seq tracks).
